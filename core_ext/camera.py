...
class Camera(Object3D):
    ...
    def set_perspective(self, angleOfView=50,aspectRatio=1, near=0.1,far=1000):
        self._projection_matrix =Matrix.make_perspective(angleOfView,aspectRatio, near, far)
