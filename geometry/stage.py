...
def StageGeometry(sx, sy, sz, obj_groups: List[Tuple[str, List, List, List]]):
    stage_geometry = None
    frame_geometry = None
    cloth01_geometry = None
    cloth02_geometry = None
    backstage_geometry = None
    ...
    for material_name, group_vertices, group_uvs, group_normals in obj_groups:
        ...
        if material_name == "stage":
            stage_geometry = geometry
        elif material_name == "frame":
            frame_geometry = geometry
        elif material_name == "cloth01":
            cloth01_geometry = geometry
        elif material_name == "cloth02":
            cloth02_geometry = geometry
        elif material_name == "backstage":
            backstage_geometry = geometry

    return stage_geometry, frame_geometry, cloth01_geometry, cloth02_geometry, backstage_geometry