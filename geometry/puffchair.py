...
def PuffChairGeometry(sx, sy, sz, obj_groups: List[Tuple[str, List, List, List]]):
    cushion_geometry = None
    chairbase_geometry = None
    ...
    for material_name, group_vertices, group_uvs, group_normals in obj_groups:
        ...
        if material_name == "chaircushion":
            cushion_geometry = geometry
        elif material_name == "chairbase":
            chairbase_geometry = geometry

    return cushion_geometry, chairbase_geometry